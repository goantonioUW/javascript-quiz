...
function init() {
  ...
  instructions.textContent =
    " You have 10 seconds to answer each question. The right answer gives you points but answer wrong and you will lose time. ";
...
function scoreAnswer(cur) {
  ...
  // ensure that the event is on the li
  var e = event.target;
  if (e.matches("li")) {
